...
namespace Sunbox.Avatars {
    ...
    public class AvatarCustomization : MonoBehaviour {
        ...
        [AvatarIntegerField("Skin Material", "skinMaterialIndex", Section = SECTION_FACE_STYLES, ArrayDependancyField = "MaleSkinMaterials")]
        public int SkinMaterialIndex = 0;

        [AvatarIntegerField("Hair Style", "hairStyleIndex", Section = SECTION_FACE_STYLES, ArrayDependancyField = "HairItems")]
        ...
        private void UpdateHair_Internal() {
            ...
            UClothingItem hatClothingInstance = CurrentBase.GetComponentsInChildren<UClothingItem>()
                .Where(item => item.ClothingItem != null && item.ClothingItem.SlotType == SlotType.Hat)
                .FirstOrDefault();
